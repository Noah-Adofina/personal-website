...
// ===== Word Count =====
const wordLabel = document.querySelector(".word-count")
const messageInput = document.querySelector("#message")

messageInput.addEventListener('input', () => {
    wordLabel.textContent = messageInput.value.length + "/1000";
    if (messageInput.value.length > 849){
      wordLabel.style.color = "#f4c16e";
      wordLabel.style.textShadow = "0 0 3px #f4c16e"
    }
    else{
      wordLabel.style.color = "#b3eaad";
      wordLabel.style.textShadow = "0 0 3px #b3eaad"
    }
})